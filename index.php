...
$base_url = '/dsb/'; // URL of the homepage. Can be absolute or relative.
$blog_title = 'ToDo List';
$contact_email = 'noreply@todolist.co.cc';
...
<head>
	...
	<link href="https://fonts.googleapis.com/css?family=Anonymous+Pro|Cutive+Mono&display=swap" rel="stylesheet"> 
</head>
<body>
	<header>
